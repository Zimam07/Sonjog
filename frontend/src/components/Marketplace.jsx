...
export default function Marketplace() {
  ...
  const handleCreateListing = async (e) => {
    ...
    try {
      ...
      if (res.data.success) {
        console.log('Listing created:', res.data.listing);
        console.log('Images in created listing:', res.data.listing.images?.length || 0);
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {listings.map((listing) => (
                ...
                >
                  {/* Image */}
                  <div className="aspect-video bg-gradient-to-br from-gray-200 to-gray-300 dark:from-gray-800 dark:to-gray-700 overflow-hidden">
                    {listing.images && listing.images.length > 0 ? (
                      <img
                        ...
                        onError={(e) => {
                          console.log('Image load error:', listing.images[0]);
                ...
                <div className="relative">
                  {listing.images && listing.images.length > 0 ? (
                    <img
                      ...
                      onError={(e) => {
                        console.log('My listing image error:', listing.images[0]);
                        e.target.style.display = 'none';
                      }}
                    />
                  ) : (
                    <div 
                      onClick={() => navigate(`/marketplace/edit/${listing._id}`)}
                      className="w-32 h-32 bg-gradient-to-br from-gray-200 to-gray-300 dark:from-gray-800 dark:to-gray-700 rounded-lg flex flex-col items-center justify-center cursor-pointer hover:from-gray-300 hover:to-gray-400 dark:hover:from-gray-700 dark:hover:to-gray-600 transition"
                    >
                      <Package size={32} className="text-gray-400 dark:text-gray-500 mb-1" />
                      <span className="text-gray-400 dark:text-gray-500 text-xs">Add images</span>
                    </div>
                  )}
                </div>
            ...
            <div className="p-6">
              ...
              <form onSubmit={handleCreateListing} className="space-y-4">
                ...
                <div>
                  ...
                  <div className="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg p-4 hover:border-purple-500 dark:hover:border-purple-400 transition">
                    <input
                      type="file"
                      accept="image/*"
                      multiple
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400 mt-2">
                      Select up to 5 images to showcase your item
                    </p>
                  </div>
